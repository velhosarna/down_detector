...
css_img = 'img.img-fluid::attr(src)'
...
def get_script():
    for url in companies:
        try:
            ...
            downdetector.append({"empresa": company_name, "company_status": company_status, "img": img})
...
def upsert_status(new_entries: list):
    ...
    for entry in new_entries:
        ...
        if name not in index:
            index[name] = {"empresa": name, "company_status": status, "img": img}
